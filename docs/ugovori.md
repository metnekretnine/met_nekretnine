...
- Poziv počinje s „Poštovani,“; agencijska obavijest glasi „Ugovor je uspješno potpisan.“ Imena nalogodavaca ostaju u predmetu obavijesti. Poslovna adresa ostaje Savska cesta 32.
...
## Dodatne završne korekcije (14. 9. 2026.)

- PDF pregled, preuzimanje iz administracije i javne poveznice, Sanity Studio i email privitci koriste jedinstveno pravilo za naziv: `MET-ugovor-Marko-Horvat-Ana-Horvat-2026-09-14.pdf`, odnosno `MET-ugovor-Marko-Horvat-Ana-Horvat-potpisan-2026-09-14.pdf`. Datum je datum ugovora iz obrasca. Za jednog nalogodavca navodi se samo njegovo ime. Razmaci i posebni znakovi zamjenjuju se sigurnim separatorima, a hrvatski dijakritici prenose se bez kvačica. Ugovori istih nalogodavaca s istim datumom mogu imati isti naziv; ne dodaje se broj ugovora ni interni ID.
- Nepotpisana poveznica vrijedi do postojećeg roka od 30 dana od izrade. Nakon potpisa javni pristup metapodacima i PDF-u istječe točno 30 × 24 sata od spremljenog vremena potpisa. Ponovno otvaranje, preuzimanje ili ponavljanje zahtjeva ne produljuje rok. Pravilo vrijedi i za ranije potpisane ugovore prema njihovom izvornom vremenu potpisa, bez migracije ili promjene PDF-a.
- Nakon isteka javni API vraća 410, a stranica prikazuje postojeću poruku da poveznica nije dostupna. Ugovor ostaje označen kao potpisan i dostupan prijavljenom administratoru u aplikaciji i Sanityju. Gumb „Otvori ugovor” za potpisani ugovor otvara PDF preko zaštićenog administratorskog API-ja, ne preko javne poveznice. Ni ugovor ni pripadajući PDF-ovi ne brišu se istekom poveznice.
- Obavijest Maji i potvrda na stranici nakon potpisa pojašnjavaju rok javnog pristupa. Već poslane poruke i njihovi privitci ostaju nepromijenjeni. Prije svakog javnog pristupa rok se provjerava na poslužitelju; ranije preuzete kopije ne mogu se opozvati.
